...
SELECT *
FROM contact_table2
WHERE contact_info->>'phone'  in('002-412-3456','000-115-0015','000-000-1590');
--5.6sec


SELECT *
from contact_table2
where contact_info->>'phone' ='002-412-3456'
or contact_info->>'phone' ='000-115-0015'
or contact_info->>'phone' ='000-000-1590'
